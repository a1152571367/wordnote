package com.example.wordnote.provider;
 ...
 * 内容跟提供器，供外界查询dict表
 */
public class WordNoteContentProvider extends ContentProvider {

    //dict表相对应的数字
    public static final int DICT_NUM = 0;

    //包路径authority
    public static final String AUTHORITY = "com.example.wordnote.provider";
    ...
    public WordNoteContentProvider() {
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher.match(uri)){
            case DICT_NUM:
                return "vnd.android.cursor.dir/vnd.com.example.wordnote.provider.dict";
        }
        return null;
    }
    ...
    public boolean onCreate() {
        ...
        dbhelper = new DataBaseHelperDict(getContext(),"dict",null,2);
        return true;
    }
